...
import com.atguigu.android.android_pulltorefresh.PullToRefreshMainActivity;
import com.atguigu.android.butterknife.ButterknifeActivity;
import com.atguigu.android.eventbus.EventBusActivity;
import com.atguigu.android.fresco.FrescoActivity;
...
import com.atguigu.android.universalvideoview.UniversalVideoViewActivity;
...
public class CommonFrameFragment extends BaseFragment {
    ...
    protected void initData() {
        ...
        //准备数据
        datas = new String[]{"OKHttp", "nativeJsonPrase", "Gson", "FastJson", "xUtils3", "Afinal", "Volley","Eventbus","Butterknife","Imageloader","Picasso","RecyclerView","Glide", "Fresco","Android-PullToRefresh","UniversalVideoView", "Retrofit2",  "greenDao", "RxJava","jcvideoplayer",  "Expandablelistview", "....."};
